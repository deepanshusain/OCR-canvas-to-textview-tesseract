    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ActivityCompat.requestPermissions(MainActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},98);
                ...
                ActivityCompat.requestPermissions(MainActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},91);
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_STORAGE);
            }
        }
        ...
        word = MediaPlayer.create(this,R.raw.mainactivity);
        ...
        result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (shows.getText().toString().equals("अ") && (Out.getText().toString().equals("अं") || Out.getText().toString().equals("आ") || Out.getText().toString().equals("अ") || Out.getText().toString().equals("हाँ") || Out.getText().toString().equals("आं") || Out.getText().toString().equals("अँ") || Out.getText().toString().equals("डा") || Out.getText().toString().equals("झ") || Out.getText().toString().equals("झा") || Out.getText().toString().equals("ञ्च") || Out.getText().toString().equals("आँ") || Out.getText().toString().equals("यें") || Out.getText().toString().equals("क्ष") || Out.getText().toString().equals("ठा") || Out.getText().toString().equals("एँयो॔"))) {
