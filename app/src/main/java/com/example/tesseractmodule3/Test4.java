            ...
            public void onClick(View v) {
                ...
                new Timer().schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        right.stop();
                        right.reset();
                        Intent intent = new Intent(Test4.this, DDAActivity.class);
                        finish();
            ...
            public void onClick(View v) {
                ...
                new Timer().schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        wrong.stop();
                        wrong.reset();
                        Intent intent = new Intent(Test4.this, CHHAActivity.class);
                        finish();
                        startActivity(intent);
                    }
                }, 3000);
