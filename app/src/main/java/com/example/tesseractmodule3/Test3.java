...
public class Test3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test = MediaPlayer.create(this,R.raw.testthree);
            ...
            public void onClick(View v) {
                ...
                new Timer().schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        right.stop();
                        right.reset();
                        Intent intent = new Intent(Test3.this, CHHAActivity.class);
                        finish();
            ...
            public void onClick(View v) {
                ...
                new Timer().schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        wrong.stop();
                        wrong.reset();
                        Intent intent = new Intent(Test3.this, KAActivity.class);
                        finish();
                        startActivity(intent);
                    }
                }, 3000);
